...
def problem_one(request):
  ...
  b_or_higher_students = Student.object.exclude(gpa__lt=3.0) and Students.objects.order_by('last_name').desc()
...
def problem_two(request):
  ...
  Instructor.object.filter(hire_date__iso_year__lt=2010).desc()
...
def problem_three(request):
  ...
  Course.object.get(pk=2)
  print(f"Intructor's_name: {Instructor.first_name} {Instructor.last_name}")
  print(f"Courses: {Course.id}")
    return complete(request)
...
def problem_four(request):
  ...
  Students.object.Count()
  Course.object.Count()
  Instructor.object.Count()
  print(f" Student Count: {Students.object.Count()")
  print(f" Course Count: {Courses.object.Count()")
  print(f" Instructor Count: {Instructor.object.Count()")
    return complete(request)
...
def problem_five(request):
  ...
  print(Student.object.get(pk=11))
    return complete(request)
...
def problem_six(request):
    ...
    print(student.object.get(student.id=11,gpa))
    return complete(request)
...
def bonus_problem(request):
  ...
  Course.object.filter(Instructor_id=1)
  print(Course.object.filter(Instructor_id=1))
    return complete(request)
